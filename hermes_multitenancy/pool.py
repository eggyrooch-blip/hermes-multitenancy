...
Implements review-v2 笔记 D7 (revised) parameters:
...
Phase 3 (real plugin lifecycle) may add a background task that calls
``evict_idle()`` on a schedule; for Spike, lazy is enough.
"""
...
class RuntimePool:
    ...
    def _evict_to_capacity(self) -> None:
        ...
        block — Phase 3 may add a wait-queue. Spike accepts the over-cap.
        """
