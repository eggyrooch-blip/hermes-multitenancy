                ...
                "credentials": [
                    {
                        ...
                        "env": "GITLAB_TOKEN",
                        "env_extra": {"GITLAB_HOST": "gitlab.gotokeep.com"},
...
def test_build_subprocess_env_wires_delegation_and_forced_mirror(
    ...
    def fake_delegation(ph, *, sender_open_id, delegation_id="", existing_env_names=()):
        ...
        if sender_open_id == OWNER_OPEN_ID:
            return {"GITLAB_TOKEN": "glpat-alice-personal", "GITLAB_HOST": "gitlab.gotokeep.com"}
        return {}
    ...
    assert env["GITLAB_HOST"] == "gitlab.gotokeep.com"
